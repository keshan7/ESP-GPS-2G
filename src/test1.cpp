...
//   String datetime;  // Added: Date and time string
//   float lat;
//   float lng;
//   float speed;
//   float altitude;
//   int satellites;
//   bool valid;  // Track if this slot has valid data
// };
...
// int currentSlot = 0;  // Which slot we're filling (0-9)
...
// const unsigned long collectionInterval = 10000; // 10 seconds between collections
// unsigned long lastSendTime = 0;
// const unsigned long sendInterval = 60000; // 60 seconds between sends
...
//       gpsBuffer[currentSlot].speed = 0; // Unknown speed
//       gpsBuffer[currentSlot].altitude = lastKnownPosition.altitude;
//       gpsBuffer[currentSlot].satellites = 0; // No current fix
//       gpsBuffer[currentSlot].valid = true;
...
//   // Build JSON payload - OLD FORMAT (simple and easy)
